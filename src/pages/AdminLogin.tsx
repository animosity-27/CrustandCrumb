...
import { Lock, Mail, Loader2, ArrowLeft, User, UserPlus } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-3xl bg-cream/95 p-8 shadow-crust backdrop-blur-xl">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <h1 className="mt-4 font-display text-2xl font-700 text-crust-900">
              {mode === 'signin' ? 'Sign In' : 'Create Account'}
            </h1>

            <p className="mt-1 text-sm text-crust-500">
              Access your Crust & Crumb account
            </p>
          </div>
          ...
          <form onSubmit={submit} className="mt-8 space-y-4">
            ...
            <div>
              <label className="mb-1.5 flex items-center gap-2 text-sm font-semibold text-crust-700">
                <Lock className="h-4 w-4 text-ocean-500" />
                Password
              </label>
